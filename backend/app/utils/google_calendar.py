...
def create_calendar_event(summary: str, description: str, candidate_email: str, start_time: datetime, duration_minutes: int = 30, recruiter_id=None, db=None) -> str:
    ...
    try:
        ...
        # sendUpdates='all' so Google emails the candidate the invite directly.
        # This is the actual delivery channel (Railway blocks the SMTP iCal email),
        # so it must NOT be 'none' or the candidate never gets notified.
